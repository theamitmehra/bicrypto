<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-(--breakpoint-xl) px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      ...
      <p class="mx-auto max-w-(--breakpoint-md) text-center text-gray-500 md:text-lg">
    ...
    <div class="grid grid-cols-2 gap-x-4 gap-y-6 sm:gap-y-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
      ...
      <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          <div class="text-center font-bold text-indigo-500 sm:text-left md:text-lg">
            John McCulling
          </div>
      ...
      <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
        ...
        <div>
          ...
          <p class="text-center text-sm text-gray-500 sm:text-left md:text-base">
            Creative Director
          </p>
        </div>
      </div>
