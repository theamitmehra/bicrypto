        ...
        <div class="rounded-lg border p-4">
          ...
          <div class="my-5 flex flex-col gap-2 border-t border-b py-5">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex h-4 flex-1 overflow-hidden rounded-sm bg-gray-200">
                <span class="h-full w-3/4 rounded-sm bg-yellow-400"></span>
              </div>
            </div>
            <!-- star - end -->
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex h-4 flex-1 overflow-hidden rounded-sm bg-gray-200">
                <span class="h-full w-1/2 rounded-sm bg-yellow-400"></span>
              </div>
            </div>
            <!-- star - end -->
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex h-4 flex-1 overflow-hidden rounded-sm bg-gray-200">
                <span class="h-full w-1/6 rounded-sm bg-yellow-400"></span>
              </div>
            </div>
            <!-- star - end -->
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex h-4 flex-1 overflow-hidden rounded-sm bg-gray-200">
                <span class="h-full w-1/4 rounded-sm bg-yellow-400"></span>
              </div>
            </div>
            <!-- star - end -->
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex h-4 flex-1 overflow-hidden rounded-sm bg-gray-200">
                <span class="h-full w-1/12 rounded-sm bg-yellow-400"></span>
              </div>
            </div>
            <!-- star - end -->
          </div>
