  ...
  >
    <div class="max-w-7xl items-end justify-between sm:flex sm:pr-6 lg:pr-8">
      ...
      <div class="mt-8 flex lg:mt-0">
        <button
          class="prev-button rounded-full border border-current p-3 text-pink-600 transition-colors focus:bg-pink-600 focus:text-white focus:outline-hidden"
        >
          <svg
        ...
        <button
          class="next-button ml-3 rounded-full border border-current p-3 text-pink-600 focus:bg-pink-600 focus:text-white focus:outline-hidden"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
