    ...
    <div class="mx-auto max-w-(--breakpoint-2xl) px-4 py-16 sm:px-6 lg:px-8">
      <div class="items-end justify-between sm:flex">
        ...
        <a
          class="mt-8 inline-flex shrink-0 items-center rounded-full border border-pink-600 px-5 py-3 font-medium text-pink-600 hover:bg-pink-600 hover:text-white sm:mt-0 lg:mt-8"
          href=""
        >
          Read all reviews
