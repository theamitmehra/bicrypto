...
<section class="bg-gray-900 text-white">
  <div class="mx-auto max-w-(--breakpoint-xl) px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div class="mt-12 text-center">
      <a
        class="mt-8 inline-flex items-center rounded-sm border border-pink-600 bg-pink-600 px-8 py-3 text-white hover:bg-transparent focus:outline-hidden focus:ring-3 active:text-pink-500 cursor-pointer"
        href="/get-started"
      >
