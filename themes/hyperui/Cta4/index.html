  ...
  <div class="p-8 md:p-12 lg:px-16 lg:py-24">
    <div class="mx-auto max-w-xl text-center sm:text-left">
      ...
      <div class="mt-4 md:mt-8">
        <button
          href="#"
          class="inline-block rounded-sm bg-red-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-red-700 focus:outline-hidden focus:ring-3 focus:ring-yellow-400"
        >
          Get Started Today
        </button>
      </div>
