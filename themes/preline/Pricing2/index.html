...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div
    class="
      ...
      before:inset-0
      before:-z-1
      bg-[radial-gradient(closest-side,#cbd5e1,transparent)]
      dark:bg-[radial-gradient(closest-side,#334155,transparent)]
    "
  >
        ...
        <table class="w-full h-px">
          ...
          <thead>
            <tr>
              ...
              <th
                class="w-1/4 py-4 px-6 text-lg leading-6 font-medium text-gray-800 text-center"
                scope="col"
              >
                Free
              </th>
