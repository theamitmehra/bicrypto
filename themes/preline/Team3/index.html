  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12">
    ...
    <div class="text-center">
      ...
      <div class="mt-2 sm:mt-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Support Consultant</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      <div class="mt-2 sm:mt-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Director of sales</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      <div class="mt-2 sm:mt-4">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Project Manager</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Sophia Harrington</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Project Manager</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Christina Kray</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Support Consultant</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Amy Forren</h3>
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Philip Williams</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Support Consultant</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Brian Lofoten</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">UI/UX Designer</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Jessica Dorsey</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Director of sales</p>
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="text-center">
      ...
      />
      <div class="mt-2 sm:mt-4">
        <h3 class="font-medium text-gray-800 dark:text-gray-200">Nick Jackson</h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">UI/UX Designer</p>
      </div>
    </div>
    <!-- End Col -->
