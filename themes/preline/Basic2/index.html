          ...
          <div class="sm:hidden">
            <button
              ...
              class="
                ...
                focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-blue-600
                transition-all
                text-sm
              "
    ...
    <main id="content" role="main">
      <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
        ...
        <p class="mt-3 text-lg text-gray-300">
          Cover is a one-page template for building simple and beautiful home pages using Tailwind
          CSS.
        </p>
        <div class="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
          <a
            class="
              ...
              hover:text-blue-600
              focus:outline-hidden
              focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-slate-900
              transition
              py-3
              px-4
            "
