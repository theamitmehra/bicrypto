...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid md:grid-cols-2 items-center gap-12">
    <div>
      ...
      <div class="mt-8">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">What can I expect?</h2>

        <ul class="mt-2 space-y-2">
          <li class="flex space-x-3">
            <svg
              class="shrink-0 h-6 w-6 text-gray-600 dark:text-gray-400"
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
            ...
            <span class="text-gray-600 dark:text-gray-400"> Industry-leading design </span>
          </li>
          ...
          <li class="flex space-x-3">
            ...
            <span class="text-gray-600 dark:text-gray-400"> Developer community support </span>
          </li>
          ...
          <li class="flex space-x-3">
            ...
            <span class="text-gray-600 dark:text-gray-400"> Simple and affordable </span>
          </li>
        </ul>
      </div>
      ...
      <!-- Brands -->
      <div class="mt-8">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Enjoyed by:</h2>
      ...
      <div class="mt-10 flex items-center gap-x-5">
        ...
        <!-- End Avatar Group -->
        <span class="text-sm text-gray-500"> Trusted by over 37k customer </span>
      </div>
    </div>
    <!-- End Col -->
