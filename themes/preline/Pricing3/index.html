          ...
          >
            ...
            <ul role="list" class="space-y-2 text-sm sm:text-base">
              <li class="flex space-x-3">
                <svg
                  class="shrink-0 h-5 w-5 text-blue-500"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                  fill="none"
                ...
                <span class="text-gray-800 dark:text-gray-200"> Up to 10 people </span>
              </li>
              ...
              <li class="flex space-x-3">
                ...
                <span class="text-gray-800 dark:text-gray-200"> Collect data </span>
              </li>
              ...
              <li class="flex space-x-3">
                ...
                <span class="text-gray-800 dark:text-gray-200"> Code extensibility </span>
              </li>
            </ul>
            <!-- End List -->
            ...
            <ul role="list" class="space-y-2 text-sm sm:text-base">
              <li class="flex space-x-3">
                <svg
                  class="shrink-0 h-5 w-5 text-gray-500"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                  fill="none"
                ...
                <span class="text-gray-800 dark:text-gray-200"> Custom reports </span>
              </li>
              ...
              <li class="flex space-x-3">
                ...
                <span class="text-gray-800 dark:text-gray-200"> Product support </span>
              </li>
              ...
              <li class="flex space-x-3">
                ...
                <span class="text-gray-800 dark:text-gray-200"> Activity reporting </span>
              </li>
            </ul>
            <!-- End List -->
          </div>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
    ...
    >
      ...
      <div class="grid grid-cols-6 gap-6">
        <div class="col-span-2">
          <span class="font-semibold text-lg text-gray-800 dark:text-gray-200"> Features </span>
        </div>
        <!-- End Col -->
        ...
        <div class="col-span-1">
          <span class="font-semibold text-lg text-gray-800 dark:text-gray-200"> Startup </span>
          <p class="mt-2 text-sm text-gray-500">$39 per month billed annually</p>
        </div>
        <!-- End Col -->

        <div class="col-span-1">
          <span class="font-semibold text-lg text-gray-800 dark:text-gray-200"> Team </span>
          <p class="mt-2 text-sm text-gray-500">$89 per month billed annually</p>
        </div>
        <!-- End Col -->

        <div class="col-span-1">
          <span class="font-semibold text-lg text-gray-800 dark:text-gray-200"> Enterprise </span>
          <p class="mt-2 text-sm text-gray-500">$149 per month billed annually</p>
        </div>
        <!-- End Col -->
      </div>
      <!-- End Grid -->
    ...
    <div class="mt-6 space-y-4 lg:space-y-0">
      ...
      <ul class="grid lg:grid-cols-6 lg:gap-6">
        <!-- Item -->
        <li class="lg:col-span-2 lg:py-3">
          <span class="text-lg font-semibold text-gray-800 dark:text-gray-200"> Social data </span>
        </li>
        <!-- End Item -->
    ...
    <div class="mt-8 md:mt-12 flex justify-center items-center gap-x-3">
      <p class="text-sm text-gray-500 dark:text-gray-400">Need a custom plan?</p>
