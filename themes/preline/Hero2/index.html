<!-- Hero -->
<div
  class="relative overflow-hidden before:absolute before:top-0 before:left-1/2 before:w-full before:h-full bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] dark:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')] bg-no-repeat bg-top bg-cover before:transform before:-translate-x-1/2 before:-z-1 before:content-['']"
>
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div class="mt-8 gap-3 flex justify-center">
      ...
      <button
        type="button"
        class="relative group p-2 ps-3 inline-flex items-center gap-x-2 text-sm font-mono rounded-lg border border-gray-200 bg-white text-gray-800 shadow-xs hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800"
      >
        $ npm i preline
        <span
