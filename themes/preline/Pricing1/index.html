...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="flex justify-center items-center">
    ...
    <input
      ...
      class="
        ...
        h-7
        bg-gray-100
        checked:bg-none checked:bg-blue-600
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    <!-- Card -->
    <div
      class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700"
    >
      ...
      <ul class="mt-7 space-y-2.5 text-sm">
        <li class="flex space-x-2">
          <svg
            class="shrink-0 h-5 w-5 text-blue-600"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr class="border-t border-gray-200 dark:border-gray-700">
              <th
                class="py-5 px-4 text-sm font-normal text-gray-600 text-left dark:text-gray-400"
                scope="row"
              >
                Open/High/Low/Close
              </th>
              <td class="py-5 pr-4">
                <!-- Check -->
                <svg
                  class="ml-auto h-7 w-7 text-blue-600"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
            ...
            <tr class="border-t border-gray-200 dark:border-gray-700">
              ...
              <td class="py-5 pr-4">
                <!-- Minus -->
                <svg
                  class="ml-auto h-7 w-7 text-gray-400"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
    ...
    <div class="hidden lg:block">
      <table class="w-full h-px">
        ...
        >
          ...
          <tr>
            <th
              class="py-5 pl-6 pr-6 text-sm font-normal text-gray-600 text-left dark:text-gray-400"
              scope="row"
            >
              Open/High/Low/Close
            </th>
            ...
            <td class="py-5 px-6">
              <!-- Check -->
              <svg
                class="mx-auto h-7 w-7 text-blue-600"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
