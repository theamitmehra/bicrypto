...
<div class="relative overflow-hidden">
  <div
    class="mx-auto max-w-(--breakpoint-md) py-12 px-4 sm:px-6 md:max-w-(--breakpoint-xl) md:py-20 lg:py-32 md:px-8"
  >
    <div class="md:pr-8 md:w-1/2 xl:pr-0 xl:w-5/12">
      ...
      <form>
        <div class="mb-4">
          <label for="hs-hero-name-2" class="block text-sm font-medium dark:text-white"
            ><span class="sr-only">Full name</span></label
          >
          <input
            type="text"
            id="hs-hero-name-2"
        ...
        <div class="mb-4">
          <label for="hs-hero-email-2" class="block text-sm font-medium dark:text-white"
        ...
        <div class="mb-4">
          <label for="hs-hero-password-2" class="block text-sm font-medium dark:text-white"
