...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      <div class="flex items-center gap-x-4">
        ...
        <div class="grow">
          ...
          <p class="text-xs uppercase text-gray-500">Support Consultant</p>
        </div>
      </div>
    ...
    >
      <div class="flex items-center gap-x-4">
        ...
        <div class="grow">
          ...
          <p class="text-xs uppercase text-gray-500">Front-end Developer</p>
        </div>
      </div>
    ...
    >
      <div class="flex items-center gap-x-4">
        ...
        <div class="grow">
          ...
          <p class="text-xs uppercase text-gray-500">Project Manager</p>
        </div>
      </div>
    ...
    <a
      ...
      href="#"
    >
      <h3 class="text-lg text-gray-800 dark:text-gray-200">We are hiring!</h3>
      <div>
        <span
          class="
            inline-flex
