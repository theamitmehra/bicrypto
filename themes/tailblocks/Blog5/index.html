        ...
        <div class="h-full flex items-start">
          ...
          <div class="grow pl-6">
            ...
            <a class="inline-flex items-center">
              <img alt="blog" src="https://dummyimage.com/103x103" class="w-8 h-8 rounded-full shrink-0 object-cover object-center">
              <span class="grow flex flex-col pl-3">
      ...
      <div class="py-8 px-4 lg:w-1/3">
        <div class="h-full flex items-start">
          ...
          <div class="grow pl-6">
            ...
            <p class="leading-relaxed mb-5">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
            <a class="inline-flex items-center">
              <img alt="blog" src="https://dummyimage.com/102x102" class="w-8 h-8 rounded-full shrink-0 object-cover object-center">
              <span class="grow flex flex-col pl-3">
      ...
      <div class="py-8 px-4 lg:w-1/3">
        <div class="h-full flex items-start">
          ...
          <div class="grow pl-6">
            ...
            <p class="leading-relaxed mb-5">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
            <a class="inline-flex items-center">
              <img alt="blog" src="https://dummyimage.com/101x101" class="w-8 h-8 rounded-full shrink-0 object-cover object-center">
              <span class="grow flex flex-col pl-3">
