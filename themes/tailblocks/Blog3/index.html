  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-12">
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        <span class="inline-block py-1 px-2 rounded-sm bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY</span>
        ...
        <a class="inline-flex items-center">
          <img alt="blog" src="https://dummyimage.com/104x104" class="w-12 h-12 rounded-full shrink-0 object-cover object-center">
      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <a class="inline-flex items-center">
          <img alt="blog" src="https://dummyimage.com/103x103" class="w-12 h-12 rounded-full shrink-0 object-cover object-center">
          <span class="grow flex flex-col pl-4">
