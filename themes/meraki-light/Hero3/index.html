...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="container px-6 py-16 mx-auto text-center">
        <div class="max-w-lg mx-auto">
            ...
            <button class="px-6 py-2.5 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-blue-600 rounded-lg hover:bg-blue-500 lg:mx-0 lg:w-auto focus:outline-hidden">
