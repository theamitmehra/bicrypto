...
<section class="bg-white dark:bg-gray-900">
    <div class="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        ...
        <div class="mt-6">
            <div class="inline-flex w-full overflow-hidden rounded-lg shadow-sm sm:w-auto sm:mx-3">
            ...
            <div class="inline-flex w-full mt-4 overflow-hidden rounded-lg shadow-sm sm:w-auto sm:mx-3 sm:mt-0">
