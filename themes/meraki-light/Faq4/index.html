...
<section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-10 mx-auto">
        ...
        <div>
            <div>
                <button class="flex items-center focus:outline-hidden">
                    <svg class="shrink-0 w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path></svg>
            ...
            <div>
                <button class="flex items-center focus:outline-hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 w-6 h-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
