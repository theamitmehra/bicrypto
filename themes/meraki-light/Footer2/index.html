    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="text-center">
            ...
            <div class="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
                ...
                <button class="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-blue-500 focus:outline-hidden focus:ring-3 focus:ring-blue-300 focus:ring-opacity-80">Get started</button>
            </div>
        </div>
