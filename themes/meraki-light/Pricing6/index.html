    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="max-w-2xl p-1.5 mx-auto overflow-hidden bg-gray-100 rounded-lg dark:bg-gray-800">
            <div class="grid gap-3 md:grid-cols-3">
                <button class="px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-transparent rounded-lg focus:outline-hidden dark:text-gray-200 dark:hover:bg-gray-600 hover:bg-gray-200">Monthly</button>

                <button class="flex items-center justify-center px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-gray-200 rounded-lg dark:bg-gray-700 focus:outline-hidden dark:text-gray-200">
                ...
                <button class="flex items-center justify-center px-3 py-2 font-medium text-gray-800 uppercase transition-colors duration-300 transform bg-transparent rounded-lg focus:outline-hidden dark:text-gray-200 dark:hover:bg-gray-600 hover:bg-gray-200">
        ...
        <div class="flex flex-col items-center justify-center mt-16 space-y-6 md:items-end md:-mx-5 md:space-y-0 md:flex-row">
            <div class="w-full px-6 py-4 transition-colors duration-300 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 dark:bg-gray-800">
                ...
                <button class="w-full px-4 py-2 mt-10 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-hidden focus:bg-blue-600">
                    Choose Basic
                </button>
            </div>
