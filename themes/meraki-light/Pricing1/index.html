    ...
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div class="w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg dark:border-gray-700">
                ...
                <button class="w-full px-4 py-2 mt-10 tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-hidden focus:bg-blue-500 focus:ring-3 focus:ring-blue-300 focus:ring-opacity-80">
                    Start Now
                </button>
            </div>
            ...
            <div class="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                ...
                <button class="w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 focus:ring-3 focus:ring-gray-200 focus:ring-opacity-80">
                    Start Now
                </button>
            </div>
