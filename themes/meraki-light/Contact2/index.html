            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    ...
                    <form class="mt-6">
                        ...
                        <button class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-hidden focus:ring-3 focus:ring-blue-300 focus:ring-opacity-50">
                            get in touch
                        </button>
                    </form>
                </div>
