...
<header>
    <nav x-data="{ isOpen: false }" class="bg-white shadow-sm dark:bg-gray-900">
    ...
    <div class="w-full bg-center bg-cover h-[32rem] relative">
        ...
        <div class="flex items-center relative justify-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="text-center">
                ...
                <button class="w-full px-4 py-2 mt-4 text-sm font-medium text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-hidden focus:bg-blue-500">Start project</button>
            </div>
        </div>
    </div>
</header>
