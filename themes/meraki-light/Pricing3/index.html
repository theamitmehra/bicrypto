...
<div class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="flex justify-center mt-8">
            <button class="px-8 py-2 tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-hidden focus:bg-blue-500 focus:ring-3 focus:ring-blue-300 focus:ring-opacity-80">
                Choose Plan
            </button>
        </div>
    </div>
