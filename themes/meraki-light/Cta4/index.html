...
<section class="bg-white dark:bg-gray-900">
    <div class="container grid grid-cols-1 gap-8 px-4 py-12 mx-auto lg:grid-cols-2">
        <div class="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <a href="#" class="inline-flex items-center justify-center w-full px-5 py-2 mt-6 text-white bg-blue-600 rounded-lg sm:w-auto hover:bg-blue-500 focus:ring-3 focus:ring-blue-300 focus:ring-opacity-80">
                Start now
            </a>
        </div>
        ...
        <div class="flex flex-col items-center max-w-lg mx-auto text-center">
            ...
            <a href="#" class="inline-flex items-center justify-center w-full px-5 py-2 mt-6 text-gray-700 transition-colors duration-150 transform bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:border-gray-700 hover:bg-gray-100 dark:text-white sm:w-auto dark:hover:bg-gray-800 dark:ring-gray-700 focus:ring-3 focus:ring-gray-200 focus:ring-opacity-80">
                Start now
            </a>
        </div>
    </div>
